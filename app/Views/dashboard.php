...
<header>
    ...
    <div class="menu">
        <ul>
            <li class="logo"><a href="#" target="_blank"><img height="44" title="CodeIgniter Logo" alt="Visit CodeIgniter.com official website!" 
            ...
            <li class="menu-item hidden"><a href="users-list">Home</a></li>
